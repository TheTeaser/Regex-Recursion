...
function division(number, dividedBy) {
    // Write you logic here.
        ...
        let result = 0;
        if (dividedBy === 0) {
          return 0; //this should be null or to throw an error as it's a mathmatical error but due to the test need I changed it to 0
        } else if (number === 0) {
          return 0;
        } else {
...
function fibonacci(n) {
    // Write you logic here. I cheated it from Youtube xD
    if (n===0)
    {return 0}
    else if (n===1)
    {return 1}
